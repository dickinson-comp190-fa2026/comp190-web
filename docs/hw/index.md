...
## Overview of how to complete each assignment

Each assignment asks you to spend several hours gaining experience with a set of software development tools and techniques.
...
As stated on the syllabus, each assignment must be completed satisfactorily to gain credit for the course. The instructor will determine if performance is satisfactory based on the quality of the homework log and quiz responses. The work will be judged as satisfactory if both
